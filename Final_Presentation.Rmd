...
- The model
- Step one: get modified t-statistics using LIMMA

## Results - Step two: finding the DERs

- Step two: group bases into regions using HMMs

## Results - Step three: assess significance of regions
...
## Results - Step four: assess significance of regions
